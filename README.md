...
Programação orientada a objetos (classes, métodos, encapsulamento, herança e polimorfismo)


Manipulação de arquivos e exceções


Generics, listas, conjuntos e mapas


Interfaces, classes abstratas e lambda expressions


Acesso a banco de dados com JDBC


Projeto final com aplicação prática


🎯 Objetivo pessoal
Aprimorar minhas habilidades em desenvolvimento backend com Java, aplicando boas práticas e preparando a base para frameworks como Spring Boot.
